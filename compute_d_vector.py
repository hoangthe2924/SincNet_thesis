...
model_file='pretrained_models/SincNet_TIMIT_pt/model_raw.pkl' # This is the model to use for computing the d-vectors (it should be pre-trained using the speaker-id DNN)
