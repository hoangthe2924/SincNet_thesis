...
def read_conf():
 ...
 options.td_lst=Config.get('data', 'td_lst')
 options.te_lst=Config.get('data', 'te_lst')
 options.al_lst=Config.get('data', 'all_lst')
...
#  options.class_act=Config.get('class', 'class_act')
 ...
 options.beta=Config.get('optimization', 'beta')
 options.margin=Config.get('optimization', 'margin')
 options.nintra=Config.get('optimization', 'nintra')
 options.loss_type=Config.get('optimization', 'loss_type')
 options.N_epochs=Config.get('optimization', 'N_epochs')
 options.start_epoch=Config.get('optimization', 'start_epoch')
